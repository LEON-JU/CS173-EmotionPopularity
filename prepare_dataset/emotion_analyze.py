...
def analyze_weibo_emotions(input_file, output_file, batch_size=1):
    """
    分析微博数据的情感并保存结果
            ...
            try:
                ...
                for score in scores:
                    ...
                    for emotion, value in score["emotions"].items():
                        df.at[absolute_idx, emotion] = value
...
if __name__ == "__main__":
    # analyze_weibo_emotions("processed_data/blog_data.csv", "emotion_analysis_output/blog_data.csv")
    analyze_weibo_emotions("processed_data/comment_data.csv", "emotion_analysis_output/comment_data.csv")
